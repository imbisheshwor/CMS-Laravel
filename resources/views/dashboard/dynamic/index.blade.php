                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <button onclick="confirm('Are you Sure want to delete?')"
                                            class="bg-gradient-to-tl from-red-600 to-orange-700 cursor-pointer px-2.5 text-xs rounded-1.8 py-1.4 inline-block whitespace-nowrap text-center align-baseline font-bold uppercase leading-none text-white">
                                            <a
                                                href="{{ route('store.delete', ['custom_post_type_slug' => $cpt->slug, 'key' => $key]) }}"><span>Delete</span></a></button>
